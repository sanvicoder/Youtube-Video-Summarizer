...
st.markdown("---")
st.write(
    "Made By Sanvi Agarwal [#Linkedin](https://www.linkedin.com/in/sanvi-agarwal-52614a24a/) !"
)
st.markdown(
    "More infos and :star: at [https://github.com/sanvicoder/Youtube-Video-Summarizer](https://github.com/sanvicoder/Youtube-Video-Summarizer)  !"
)
